...
const DailyDiscount = () => {
  const products = [
    {
      image: "/imgs/product2handsfree.jpg",
    ...
    {
      image: "/imgs/product4powerbank10000.jpg",
    ...
    {
      image: "/imgs/product5powerbank20000.jpg",
    ...
    {
      image: "/imgs/product3masagor.jpg",
  ...
  return (
    <section className="max-w-7xl mx-auto my-8 px-4 py-8 bg-gray-200 rounded-xl flex flex-col">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        >
          <img
            src="/imgs/discount-percent-svgrepo-com.svg"
            alt="discount"
            className="w-10 h-10"
          />
      ...
      {/* Products */}
      <div className="flex flex-col lg:flex-row gap-4 min-h-175">
