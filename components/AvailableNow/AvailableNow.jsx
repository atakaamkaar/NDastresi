        ...
        {products.map((product) => (
          <SwiperSlide key={product.id}>
            <Link href={product.link} className="flex justify-center">
              <div className="flex flex-col rounded-xl bg-white shadow hover:shadow-lg transition-shadow w-72.5 h-95 relative">
                {/* Status Dot */}
                <span
                ...
                <img
                  src={product.image}
                  alt={product.title}
                  className="w-full h-62.5 object-contain rounded-t-xl mx-auto"
                />
